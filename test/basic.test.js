...
test("xtream helpers", () => {
  const url =
    "http://demo.example.com:80/get.php?username=u&password=p&type=m3u&output=ts";
  ...
  const m3uUrl = buildXtreamM3uUrl(
    { host: "http://demo.example.com:80", username: "u", password: "p" },
    { type: "m3u", output: "ts" },
  );
