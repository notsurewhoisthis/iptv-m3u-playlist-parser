...
import { parseXmltvPrograms, buildChannelCategoryMap, parseXmltvDate } from '../dist/index.js';

test('parse xmltv programmes and build categories', () => {
  const xml = readFileSync(new URL('./xmltv_programs_sample.xml', import.meta.url), 'utf8');
